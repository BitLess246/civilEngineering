...
export function NotConfigured() {
  return (
    <FormAlert tone="info">
      ...
      <p className="mt-1">
        Set <code className="rounded bg-sheet/70 px-1">{AUTH_ENV_KEYS[0]}</code> and{' '}
        <code className="rounded bg-sheet/70 px-1">{AUTH_ENV_KEYS[1]}</code> from your Supabase project
