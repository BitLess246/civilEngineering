  ...
  return [
    ...
    },
    {
      ...
      lines: [
        ...
        'A SECTION SHOWS EVERY BAR IN THE CAGE. UNDER A SINGLY-REINFORCED CHECK ONLY THE TENSION FACE COUNTS IN φMn; THE OTHER FACE IS CONTINUITY STEEL (§409.7.3.8) AND HANGERS. THE CALLOUT NAMES THE FACE THE CAPACITY CAME FROM.',
