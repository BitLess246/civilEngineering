...
export function LegalLayout({ title, subtitle, children }: {
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-10">
      ...
      <div className="prose-sm mt-6 space-y-5 text-[14px] leading-7 text-ink-2">{children}</div>

      <div className="mt-10 border-t border-hairline pt-5 text-[13px] text-muted">
