...
export const DESIGN_TOOLS: DocTool[] = [
  ...
  },
  {
    ...
    route: '/steel',
    group: 'Steel & timber',
    summary: 'AISC member checks — beam flexure and shear, column compression, combined forces — plus shear tabs and moment connections.',
    basis: 'AISC 360-16 §F2 flexure, §G2.1 shear, §E3 compression, §H1-1 combined, §J bolts/welds/block shear.',
    sections: [
      {
        id: 'sd-beam',
        title: 'Beam',
      ...
      },
      {
        ...
        controls: [
          ...
          { kind: 'choice', name: 'Type / Grade', what: 'Bolt type and grade (A325M, A490M).' },
          ...
          { kind: 'field', name: 'Weld size w', unit: 'mm', what: 'Fillet weld leg size, which sets the throat and hence the strength.' },
          { kind: 'choice', name: 'Electrode', what: 'Filler metal classification, which sets the weld strength.' },
          { kind: 'choice', name: 'Steel grade', what: 'Member steel grade (Fy/Fu).' },
        ],
      },
    ],
  },
