...
export const SITE_TOOLS: DocTool[] = [
  ...
  },
  {
    ...
    group: 'Foundations & geotechnical',
    summary: 'Lateral thrust on a wall — Rankine and Coulomb, active and passive, with the seismic case.',
    basis: 'Rankine (1857); Coulomb (1776); Mononobe–Okabe.',
    sections: [
      {
        id: 'ep-soil',
        title: 'Soil & wall',
        controls: [
          { kind: 'field', name: 'γ', unit: 'kN/m³', what: 'Unit weight of the retained soil.' },
          { kind: 'field', name: 'φ', unit: '°', what: 'Angle of internal friction — the only soil property Rankine needs.' },
          { kind: 'field', name: 'Wall height H', unit: 'm', what: 'Height of the face the thrust acts on.' },
          { kind: 'field', name: 'Surcharge q', unit: 'kPa', what: 'Uniform load on the backfill surface. Adds a RECTANGULAR pressure block acting at H/2, not H/3.' },
        ],
      },
      {
        id: 'ep-coulomb',
        title: 'Coulomb geometry',
        controls: [
          { kind: 'field', name: 'Wall friction δ', unit: '°', what: 'Friction on the back of the wall. Tilts the thrust off horizontal; the vertical component helps resist sliding and overturning.' },
          { kind: 'field', name: 'Back face θ', unit: '°', what: 'Inclination of the wall back face from vertical.' },
          { kind: 'field', name: 'Backfill slope β', unit: '°', what: 'Slope of the fill surface. With δ = θ = β = 0 Coulomb reduces exactly to Rankine.' },
        ],
      },
      {
        id: 'ep-seismic',
        title: 'Seismic (Mononobe–Okabe)',
        controls: [
          { kind: 'field', name: 'Horizontal kh', what: 'Pseudo-static horizontal coefficient. Zero disables the seismic case.' },
          { kind: 'field', name: 'Vertical kv', what: 'Pseudo-static vertical coefficient.' },
        ],
      },
    ],
  },
  {
    ...
    route: '/bearing-capacity',
    group: 'Foundations & geotechnical',
    summary: 'Shallow-foundation bearing capacity by the general equation, with the method named explicitly.',
    basis: 'Prandtl/Reissner Nq and Nc; Meyerhof, Hansen or Vesić Nγ and shape/depth factors.',
    sections: [
      {
        id: 'bc-soil',
        title: 'Soil',
        controls: [
          { kind: 'field', name: 'Cohesion c', unit: 'kPa', what: 'Drives the Nc term — dominant in clay.' },
          { kind: 'field', name: 'φ', unit: '°', what: 'Sets all three bearing-capacity factors.' },
          { kind: 'field', name: 'γ / γsat', unit: 'kN/m³', what: 'Moist and saturated unit weights, used either side of the water table.' },
          { kind: 'field', name: 'Water table depth', unit: 'm', what: 'Reduces both the surcharge and the γ in the Nγ term. Leave blank for none.' },
        ],
      },
      {
        id: 'bc-footing',
        title: 'Footing',
        controls: [
          { kind: 'field', name: 'Width B / Length L', unit: 'm', what: 'Plan dimensions; B is the short side.' },
          { kind: 'field', name: 'Founding depth Df', unit: 'm', what: 'Sets the surcharge and the depth factors.' },
          { kind: 'field', name: 'Eccentricity eB', unit: 'm', what: "Meyerhof's effective area: B′ = B − 2eB, and B′ is what goes into the Nγ term." },
          { kind: 'field', name: 'Load inclination β', unit: '°', what: 'Inclination of the resultant from vertical, which drives the i-factors.' },
          { kind: 'toggle', name: 'Strip footing (L → ∞)', what: 'Drops the shape factors to the plane-strain case.' },
        ],
      },
      {
        id: 'bc-method',
        title: 'Method & safety',
        controls: [
          { kind: 'choice', name: 'Meyerhof / Hansen / Vesić', what: 'They disagree by design — only Nγ and the shape/depth factors differ. All three are shown side by side so the spread is visible.' },
          { kind: 'field', name: 'Factor of safety', what: 'Applied to the NET capacity. Compare a footing pressure to the net allowable, not the gross.' },
        ],
      },
    ],
  },
