    ...
    sections: [
      ...
      },
      {
        ...
        controls: [
          ...
          { kind: 'output', name: 'Governing lane-load placements', what: 'For the selected section: how much of the beam a uniform lane load has to cover for the worst negative moment, the dead length (always the whole span), and the resulting worst negative moment and worst positive shear — each split into its dead and live parts. Follows the section you choose rather than a fixed one.' },
